...
The instructions for configuring the Vast Database on a Vast Cluster can be found here: 
...
Also see [example automation](../misc/vastdb_py_setup.ipynb) for configuring Vast Ddatabase.
